            ...
            s(8221),
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    const e = document.querySelector(".searchbox"),
                        t = document.querySelector(".header__block-search svg"),
                        s = document.querySelector(".header__block-close"),
                        i = document.querySelector("header");
                    t &&
                        s &&
                        e &&
                        (t.addEventListener("click", function () {
                            e.classList.add("show"), (t.style.display = "none"), (s.style.display = "block"), window.innerWidth < 640 && (i.style.height = "140px");
                        }),
                        s.addEventListener("click", function () {
                            e.classList.remove("show"), (t.style.display = "block"), (s.style.display = "none"), window.innerWidth < 640 && (i.style.height = "100px");
                        }),
                        window.addEventListener("click", function (r) {
                            e.contains(r.target) || r.target === t || r.target === s || (e.classList.remove("show"), (t.style.display = "block"), (s.style.display = "none"), window.innerWidth < 640 && (i.style.height = "100px"));
                        }));
                    const r = document.querySelector(".header__block-mobile-menu"),
                        n = document.querySelector(".mobile-nav"),
                        a = n.querySelector(".mobile-nav__close");
                    r.addEventListener("click", function (t) {
                        n.classList.add("show"), e.classList.remove(".show");
                    }),
                        a.addEventListener("click", function (e) {
                            n.classList.remove("show"), e.stopPropagation();
                        }),
                                ...
                                e.querySelectorAll("svg path").forEach((e) => {
                                    ...
                                    (function (e) {
                                        if (navigator.clipboard && window.isSecureContext)
                                            ...
                                            try {
                                                const e = document.execCommand("copy") ? "успешно" : "не";
                                                console.log(`Текст ${e} скопирован в буфер обмена`);
                                            } catch (e) {
                                                console.error("Не удалось скопировать текст: ", e);
                                            }
